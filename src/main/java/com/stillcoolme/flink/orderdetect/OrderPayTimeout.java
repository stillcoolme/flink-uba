 ...
 * @author stillcoolme
 * @version 1.0.0
 * @createTime 2021-09-06 18:52:00
 * @Description
 *   CEP检测超时未支付的订单
 */
public class OrderPayTimeout {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<OrderResult> resultStream =
                patternStream.select(orderTimeoutTag, new OrderTimeoutSelect(), new OrderPaySelect());

        // resultStream 里面的是正常支付的
        resultStream.print("payed normally");
        // orderTimeoutTag 侧流里的是超时的
